...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        translateButton = (Button) findViewById(R.id.buttonTrans);
        ...
        if (getResources().getConfiguration().locale.getLanguage().equals("en") ){
            translateButton.setText(getResources().getString(R.string.translate_ru));
        } else {
            translateButton.setText(getResources().getString(R.string.translate_en));
        }
